...
quantiles_old = np.loadtxt("./outdir/quantiles_old.txt")
...
ax[4,1].set_axis_off()
ax[0,0].legend(handles=handles, labels=["Surrogate \\textsc{afterglowpy}", "Surrogate \\textsc{afterglowpy} old"], fontsize=12, fancybox=False, framealpha=1)
